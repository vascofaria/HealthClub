...
public class GroupClassTest {
	...
	@Test
	public void testValidBeginHour1() throws InvalidInvocationException {
		// Arrange
	...
	@Test
	public void testInvalidBeginHour1() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
		try {
	...
	@Test
	public void testValidBeginHour2() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
	...
	@Test
	public void testInvalidBeginHour2() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
		try {
			this.groupClass = new GroupClass(10, 5, 8, healthClub, 3, true);
			...
			assertEquals(groupClass.getDuration(), 5);
	...
	@Test
	public void testValidCapacity1() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
	...
	@Test
	public void testInvalidCapacity1() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
		try {
	...
	@Test
	public void testValidCapacity2() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
	...
	@Test
	public void testInvalidCapacity2() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
		try {
	...
	@Test
	public void testValidMinAge1() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
	...
	@Test
	public void testInvalidMinAge1() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
		try {
	...
	@Test
	public void testInvalidMinAge2() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
		try {
	...
	@Test
	public void testValidMinAge2() throws InvalidInvocationException {
		// Arrange
		HealthClub healthClub = new HealthClub("club");
		// Act
